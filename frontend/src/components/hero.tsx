    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center gap-8 px-6 text-center">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
          <Button asChild className="h-11 rounded-full bg-[#111111] px-7 font-sans text-sm font-medium text-white transition-opacity hover:bg-[#111111]/90 hover:opacity-90">
